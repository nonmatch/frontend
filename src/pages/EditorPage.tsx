...
import { calculateFakenessScore } from "../utils/fakenessScore";
    ...
    const common = (
        <>
            ...
            <SubmitDialog
                ...
                setEmail={setEmail}
            ></SubmitDialog>
            <SuccessToast score={score} fakenessScore={fakenessScore} isLoggedIn={isLoggedIn} copyLink={copyLink}></SuccessToast>
