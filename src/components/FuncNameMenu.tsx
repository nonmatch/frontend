...
export const FuncNameMenu: React.FC<FuncNameMenuProps> = ({ name, copyLink, isCustom, exportCExplore, exportDecompMe, showOneColumn, usesTextarea, setUseTextarea, enterAsm, viewSubmissions, isLoggedIn, isEquivalent, toggleEquivalent, hasUnsubmittedChanged }) => {
  return (
    <div className="dropdown" style={{ position: "inherit" }}>
      ...
      <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
        ...
        {isLoggedIn && !hasUnsubmittedChanged && <li><button className="dropdown-item" onClick={toggleEquivalent}>{isEquivalent ? "Mark non-equivalent" : "Mark equivalent"}</button></li>}
